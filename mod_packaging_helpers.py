...
<!--
    ...
    Use the FOMOD Creation Tool (https://github.com/GandaG/fomod-designer)
    or Nexus FOMOD Creation Tool to build more complex installers.
-->
...
"""
            ...
            return True, (
                ...
                f"  Tip: use FOMOD Creation Tool to add optional components"
            )
        except Exception as exc:
