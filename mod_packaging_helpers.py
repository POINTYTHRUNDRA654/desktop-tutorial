...
<!--
    FOMOD info.xml
    Generated by Mossy's Blender Add-On (Blender add-on) on {datetime.date.today()}
...
- Mossy's Blender Add-On (Blender add-on) used for mesh / texture preparation.
...
*README generated by Mossy's Blender Add-On – {datetime.date.today()}*
"""
    ...
    def _write_ba2_scripts(mod_root: str, mod_name: str) -> None:
        ...
        bat = f"""@echo off
REM pack_ba2.bat – generated by Mossy's Blender Add-On
...
"""
        ...
        sh = f"""#!/bin/bash
# pack_ba2.sh – generated by Mossy's Blender Add-On
    ...
    def export_manifest(mod_root: str, info: dict) -> tuple[bool, str]:
        ...
        try:
            ...
            manifest = {
                ...
                "generated_by":  f"Mossy's Blender Add-On (Blender add-on) v{_addon_version}",
