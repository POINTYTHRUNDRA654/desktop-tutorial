...
_FO4_SYSTEM_CONTEXT = (
    ...
    "    Stage + Final, 'Tag Selected as Plot Stage'), Spawn Markers ('Add Spawn Marker at\n"
    "    Cursor' + Form EditorID field), Export Plot (Prefix/Plan Name/Build Material/Output\n"
    "    Folder → exports NIF+BGSM per stage, writes an xEdit Static-record script +\n"
    "    Models.csv + Spawns.csv for the user's own SS2_ImportStageData.pas xEdit script)\n\n"
