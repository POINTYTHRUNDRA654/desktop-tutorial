content = r"""import React, { useEffect, useState, useCallback, useRef } from 'react';
...
with open('D:/Projects/desktop-tutorial/src/renderer/src/FO4NPCDirector.tsx', 'w', encoding='utf-8') as f:
    f.write(content)

d = open('D:/Projects/desktop-tutorial/src/renderer/src/FO4NPCDirector.tsx', 'rb').read()
