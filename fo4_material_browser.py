...
PRESETS: dict = {
    ...
    # ── FO4 Shader Types ─────────────────────────────────────────────────────
    "FO4_EYE": {
        "label":             "Eye (FO4 Eye Shader)",
        "description":       "NPC / creature eye – uses the FO4 eye shader with cube-map reflection",
        "base_color":        (0.60, 0.45, 0.30),
        "roughness":         0.10,
        "metallic":          0.0,
        "alpha_mode":        "BLEND",
        "alpha_threshold":   0.1,
        ...
        "two_sided":         False,
        "fo4_shader":        "eye",
        "texture_hint":      "_d, _n, _s, _e (environment cube map)",
    },
    "FO4_HAIR": {
        "label":             "Hair (FO4 Hair Shader)",
        "description":       "NPC hair strand – alpha-clipped with two-sided rendering",
        "base_color":        (0.20, 0.15, 0.10),
        "roughness":         0.90,
        "metallic":          0.0,
        "alpha_mode":        "CLIP",
        "alpha_threshold":   0.5,
        ...
        "two_sided":         True,
        "fo4_shader":        "hair",
        "texture_hint":      "_d (+ alpha), _n, _s",
    },
    "FO4_PARALLAX": {
        "label":             "Parallax Surface",
        "description":       "Wall or floor with parallax occlusion depth effect",
        "base_color":        (0.40, 0.38, 0.35),
        "roughness":         0.85,
        "metallic":          0.0,
        "alpha_mode":        "OPAQUE",
        "alpha_threshold":   0.5,
    ...
    "FO4_ENV_MAP": {
        ...
        "description":       "Shiny surface with cube-map environment reflection",
        "base_color":        (0.60, 0.62, 0.65),
        "roughness":         0.15,
        "metallic":          0.8,
        "alpha_mode":        "OPAQUE",
        "alpha_threshold":   0.5,
        ...
        "two_sided":         False,
        "fo4_shader":        "env",
        "texture_hint":      "_d, _n, _s, _e (environment mask)",
    },
    "FO4_MULTILAYER": {
        "label":             "Multilayer Parallax",
        "description":       "High-quality multilayer parallax for premium floors and walls",
