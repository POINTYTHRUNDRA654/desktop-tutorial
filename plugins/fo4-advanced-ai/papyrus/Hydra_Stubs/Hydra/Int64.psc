Scriptname Hydra:Int64 Const Hidden Native

;/
	Provides functions and a wrapper for signed 64-bit integers.

	Notes:
	- For string format specifications, see: https://fmt.dev/latest/syntax.
	  Example: `Hydra:Int64.Format(Hydra:Int32.ToLong(123), "0x{:X}")` -> "0x7B"
/;
...
Long Function Negate(Long alValue) Global Native

Long Function LeftShift(Long alValue, int alShift) Global Native
Long Function RightShift(Long alValue, int alShift) Global Native
...
Long Function Abs(Long alValue) Global Native
