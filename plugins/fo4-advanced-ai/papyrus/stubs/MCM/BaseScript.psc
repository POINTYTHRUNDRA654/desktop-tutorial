Scriptname MCM:BaseScript extends Quest
...
; ── State-based options ───────────────────────────────────────────────────────
Int Function AddToggleOptionST(String asState, String asText, Bool abValue, Int aiFlags = 0) Native
Int Function AddSliderOptionST(String asState, String asText, Float afValue, String asFormatString = "{0}", Int aiFlags = 0) Native
Int Function AddMenuOptionST(String asState, String asText, String asValue, Int aiFlags = 0) Native
Int Function AddTextOptionST(String asState, String asText, String asValue, Int aiFlags = 0) Native
...
Function SetToggleOptionValueST(Bool abValue, Bool abNoUpdate = False, String asState = "") Native
Function SetSliderOptionValueST(Float afValue, String asFormatString = "{0}", Bool abNoUpdate = False, String asState = "") Native
Function SetMenuOptionValueST(String asValue, Bool abNoUpdate = False, String asState = "") Native
Function SetTextOptionValueST(String asValue, Bool abNoUpdate = False, String asState = "") Native
