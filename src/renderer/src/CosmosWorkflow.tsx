  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <ToolsInstallVerifyPanel
        ...
        shortcuts={[
          { label: 'Knowledge Search', to: '/learn/knowledge' },
          { label: 'External Tools Settings', to: '/settings/tools' },
          { label: 'Local Capabilities', to: '/learn/capabilities' },
        ]}
      />
          ...
          return (
            <div key={repo.id} className="bg-slate-900/60 border border-slate-800 rounded-lg p-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  to="/learn/knowledge"
                  className="px-4 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded text-xs font-semibold text-slate-200"
                >
