...
import { Book, Upload, Trash2, Search, Brain, FileText, CheckCircle2, Loader2, Sparkles, Database, Plus, X, Activity, Cloud, Files, Download, Share2, Bell, PackageOpen, RefreshCw, Box } from 'lucide-react';
