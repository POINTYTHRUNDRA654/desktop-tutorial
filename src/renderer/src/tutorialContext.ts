  ...
  'nexus': {
    ...
    controls: [
      ...
      },
      {
        ...
        type: 'button',
        description: 'Opens the Knowledge Hub with search, quick reference, and community docs',
    ...
    commonMistakes: [
      ...
      'Clicking "Help" and expecting it to open external docs — it opens the in-app Knowledge Hub',
