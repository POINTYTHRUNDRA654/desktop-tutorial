      ...
      <div className={headerClassName}>
        ...
        <div className="mb-4 bg-slate-900/60 border border-slate-700 rounded-lg p-4">
          <div className="text-xs text-slate-300 space-y-2">
            <p className="text-slate-200 font-bold">Tools / Install / Verify (Fallout 4)</p>
            <ul className="list-disc list-inside space-y-1">
              <li><strong>.psc files</strong> are Papyrus source scripts (from CK, or generated by a transpiler like PaperScript).</li>
              <li><strong>.pex files</strong> are compiled scripts the game actually runs (built by Creation Kit).</li>
              <li><strong>First test loop:</strong> analyze <code className="text-purple-200">.psc</code> → compile in CK → ship <code className="text-purple-200">.pex</code> → trigger in-game.</li>
            </ul>
