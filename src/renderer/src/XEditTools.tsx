...
const XEDIT_SCRIPTS: XEditScript[] = [
  ...
  // ── ESL / FormID ─────────────────────────────────────────────────────────────
  {
    ...
    description: 'Reassigns all new FormIDs to the 0x800–0xFFF ESL-safe range',
    detail: 'ESL plugins can only define FormIDs in 0x800–0xFFF (2,048 slots). Run this BEFORE flagging as ESL and BEFORE distributing. Never compact after a save-game has referenced this plugin — it will break those saves.',
    category: 'ESL',
    difficulty: 'intermediate',
    icon: Hash,
    estimatedTime: '< 1 min',
  ...
  },
  {
    ...
    detail: 'Scans all records added by this plugin and reports whether their FormIDs are already within 0x800–0xFFF. If they are, you can flag the plugin as ESL without compacting. If not, compact first.',
    category: 'ESL',
    difficulty: 'beginner',
    icon: Hash,
    estimatedTime: '< 1 min',
