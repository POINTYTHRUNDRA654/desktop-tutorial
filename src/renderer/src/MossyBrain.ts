...
- Your prompt text and any text context you explicitly submit
- Optional conversation context needed to answer your request
...
**Changelog:**
v1.0 - Initial Nexus release text completed with provider/data transparency details
\`\`\`
