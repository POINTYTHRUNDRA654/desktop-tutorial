...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onToggle, onClose }) => {
  ...
  const navItems = [
    ...
    { to: '/ck-crash-prevention?tab=audit', icon: Scan, label: t('nav.auditor', 'The Auditor') },
