...
const CommandPalette: React.FC = () => {
    ...
    const actions: Action[] = [
        ...
        { id: 'nav-ext-tools', title: 'FO4 External Integrations Hub', subtitle: 'MO2, ComfyUI, and Upscayl workflows', icon: Package, group: 'Navigation', action: () => navigate('/ext-tools'), keywords: ['external integrations', 'external tools', 'mo2', 'comfyui', 'upscayl', 'mod organizer 2'] },
